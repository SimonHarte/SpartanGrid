...
> Requires [LessCSS](https://github.com/less/less.js) version 1.4.0 or above. Currently **not** working with v1.7.0 
because of [this bug](https://github.com/less/less.js/pull/1929#issuecomment-45307325).
